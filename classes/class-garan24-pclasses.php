...
class WC_Gateway_Garan24_PClasses {
	 ...
	 * @since 1.0.0
	 */
	public function __construct( $garan24 = false, $type = false, $country = false ) {
	...
	/**
	 * Retrieve the PClasses from Garan24
	 *
	 * @since 1.0.0
	 */
