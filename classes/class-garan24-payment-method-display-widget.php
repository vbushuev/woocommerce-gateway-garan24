...
/**
 * Class WC_Garan24_Payment_Method_Display_Widget
 *
 * Using Garan24's Payment method display you generate trust and increase your conversion.
 *
 * @class        WC_Garan24_Payment_Method_Display_Widget
 * @version        1.0
 * @since        2.0
...
class WC_Garan24_Payment_Method_Display_Widget extends WP_Widget {

	/**
	 * Register widget with WordPress.
	 */
	function __construct() {
		parent::__construct( 'garan24_pmd', // Base ID
			__( 'Garan24 Payment Method Display Widget', 'woocommerce-gateway-garan24' ), // Name
			array( 'description' => __( 'Displays an image that informs the consumer about the payment methods that are available in your store.', 'woocommerce-gateway-garan24' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		echo "<img style='display:block;width:100%;height:auto;' src='https://cdn.garan24.com/1.0/shared/image/generic/badge/$garan24_locale/checkout/$design-$color.png?width=$width' />";
	...
	public function form( $instance ) {
		...
		<p>Read more about the options <a target="_blank"
		                                  href="http://developers.garan24.com/en/se+php/kco-v2/payment-method-display">here</a>.
		</p>
		<?php
	}
