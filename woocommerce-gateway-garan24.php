 ...
 * Developer:       Krokedil
 * Developer URI:   http://garan24.com/
...
function init_garan24_gateway() {
	...
	class WC_Gateway_garan24 extends WC_Payment_Gateway {
		...
		function Garan24_load_scripts() {
			...
			if ( is_checkout() ) {
				wp_register_script( 'garan24-base-js', 'https://garan24.com/public/core/v1.0/js/garan24.min.js', array( 'jquery' ), '1.0', false );
				//wp_register_script( 'garan24-base-js', 'https://cdn.garan24.com/public/kitt/core/v1.0/js/Garan24.min.js', array( 'jquery' ), '1.0', false );
				wp_register_script( 'garan24-terms-js', 'https://garan24.com/public/toc/v1.0/js/garan24.terms.min.js', array( 'Garan24-base-js' ), '1.0', false );
				//wp_register_script( 'garan24-terms-js', 'https://cdn.garan24.com/public/kitt/toc/v1.1/js/Garan24.terms.min.js', array( 'Garan24-base-js' ), '1.0', false );
	...
	// Composer autoloader
	/* to change *///require_once __DIR__ . '/vendor/autoload.php';
	...
	/* to change *///require_once 'classes/class-garan24-invoice.php'; // KPM Invoice
	/* to change *///require_once 'classes/class-garan24-process-checkout-kpm.php'; // KPM process checkout fields
	/* to change *///require_once 'classes/class-garan24-payment-method-widget.php'; // Partpayment widget
	/* to change *///require_once 'classes/class-garan24-get-address.php'; // Get address
	/* to change *///require_once 'classes/class-garan24-pms.php'; // PMS
	/* to change *///require_once 'classes/class-garan24-order.php'; // Handles Garan24 orders
	/* to change *///require_once 'classes/class-garan24-payment-method-display-widget.php'; // WordPress widget

	// register Foo_Widget widget
	/* to change//function register_garan24_pmd_widget() {
